...
--
-- Table structure for table `cmd_budget_trcwhale_comments`
--

CREATE TABLE `cmd_budget_trcwhale_comments` (
...
--
-- Indexes for table `cmd_budget_trcwhale_comments`
--

ALTER TABLE `cmd_budget_trcwhale_comments`
